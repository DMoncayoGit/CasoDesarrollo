...
$calificaciones = $estudianteModel->obtenerCalificaciones($_SESSION['id_usuario_hex']);
...
<body>
    ...
    <main id="seccionContenido" class="container my-1">
        ...
        <table id="tablaCalificaciones" class="table table-striped table-bordered shadow-sm">
